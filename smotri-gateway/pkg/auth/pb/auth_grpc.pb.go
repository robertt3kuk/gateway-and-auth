...
func (c *authServiceClient) TokenValidate(ctx context.Context, in *TokenValidateRequest, opts ...grpc.CallOption) (*TokenValidateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.AuthService/TokenValidate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetNewToken(ctx context.Context, in *GetNewTokenRequest, opts ...grpc.CallOption) (*GetNewTokenResponse, error) {
	out := new(GetNewTokenResponse)
	err := c.cc.Invoke(ctx, "/auth.AuthService/GetNewToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) GetNewToken(context.Context, *GetNewTokenRequest) (*GetNewTokenResponse, error) {
...
func _AuthService_TokenValidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.AuthService/TokenValidate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_GetNewToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetNewToken(ctx, req.(*GetNewTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
